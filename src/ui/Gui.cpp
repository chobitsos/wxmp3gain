...
DialogSettings::DialogSettings( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	gui_sldConstantGain->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
...
DialogSettings::~DialogSettings()
{
	...
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
	gui_sldConstantGain->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( DialogSettings::OnsldConstantGainSliderUpdated ), NULL, this );
